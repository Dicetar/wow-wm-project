    ...
    print(json.dumps(
        {
            ...
            "quests": {
                ...
                "options": [{"entry_id": x.entry_id, "label": x.label, "summary": x.summary} for x in quests.options],
            },
            "items": {
                "kind": items.kind,
                "source_path": items.source_path,
                "options": [{"entry_id": x.entry_id, "label": x.label, "summary": x.summary} for x in items.options],
            },
            "spells": {
                "kind": spells.kind,
                "source_path": spells.source_path,
                "options": [{"entry_id": x.entry_id, "label": x.label, "summary": x.summary} for x in spells.options],
            },
        },
        indent=2,
        ensure_ascii=False,
