...
def main() -> None:
    ...
    quests = build_quest_candidates(base / "quest_template.json", limit=5)
    items = build_item_candidates(base / "item_template.json", limit=5)
    spells = build_spell_candidates(base / "spell_dbc.json", limit=5)
