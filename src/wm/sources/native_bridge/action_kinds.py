...
NATIVE_ACTION_KINDS: tuple[NativeActionKind, ...] = (
    ...
    NativeActionKind("player_random_enchant_item", "inventory", "medium", implemented=True, description="Apply random-enchant module-style enchants to one existing scoped-player item."),
