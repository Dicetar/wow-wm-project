...
NATIVE_ACTION_KINDS: tuple[NativeActionKind, ...] = (
    NativeActionKind("player_apply_aura", "player", "medium", description="Apply an aura spell to the scoped player."),
    NativeActionKind("player_remove_aura", "player", "medium", description="Remove an aura spell from the scoped player."),
    NativeActionKind("player_cast_spell", "player", "medium", description="Make the scoped player cast a spell."),
    NativeActionKind("player_learn_spell", "player", "medium", description="Teach the scoped player a spell."),
    NativeActionKind("player_unlearn_spell", "player", "medium", description="Remove a learned spell from the scoped player."),
    NativeActionKind("player_add_xp", "player", "medium", description="Grant experience to the scoped player."),
    NativeActionKind("player_add_money", "player", "medium", description="Grant copper to the scoped player."),
    NativeActionKind("player_remove_money", "player", "medium", description="Remove copper from the scoped player."),
    NativeActionKind("player_add_reputation", "player", "medium", description="Adjust faction reputation for the scoped player."),
    ...
    NativeActionKind("player_restore_health_power", "player", "low", description="Restore health and power for the scoped player."),
    NativeActionKind("player_set_speed", "player", "medium", description="Temporarily adjust player movement speed."),
    NativeActionKind("player_add_item", "inventory", "medium", description="Add an item to the scoped player."),
    ...
    NativeActionKind("quest_add", "quest", "medium", description="Add a quest to the scoped player."),
    ...
    NativeActionKind("creature_spawn", "world_object", "medium", description="Spawn a WM-owned creature."),
    NativeActionKind("creature_despawn", "world_object", "medium", description="Despawn a WM-owned creature."),
    ...
    NativeActionKind("creature_set_display_id", "world_object", "medium", description="Set WM-owned creature display ID."),
    NativeActionKind("creature_set_scale", "world_object", "medium", description="Set WM-owned creature scale."),
    ...
    NativeActionKind("creature_say", "world_object", "low", description="Make a WM-owned creature say text."),
    ...
    NativeActionKind("creature_emote", "world_object", "low", description="Make a WM-owned creature emote."),
    NativeActionKind("creature_cast_spell", "world_object", "medium", description="Make a WM-owned creature cast a spell."),
