...
def _render_summary(result: LiveItemPublishResult) -> str:
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m wm.items.live_publish")
