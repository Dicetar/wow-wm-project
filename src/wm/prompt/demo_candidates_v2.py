...
def main() -> None:
    ...
    quests = build_quest_candidates_v2(export_base / "quest_template.json", limit=5)
    items = build_item_candidates_v2(export_base / "item_template.json", limit=5)
    spells = build_spell_candidates_v2(export_base / "spell_dbc.json", limit=5)
