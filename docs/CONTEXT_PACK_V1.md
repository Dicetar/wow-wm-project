...
Current expected result for the snapshot command is `WORKING` when player `5406` is online in the bridge lab.
...
- optional fresh `context_snapshot_request` issuance before pack assembly
